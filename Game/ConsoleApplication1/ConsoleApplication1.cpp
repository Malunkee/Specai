...
char game_over(int score)
{
    ...
    cout << "                                       Difficulty level: " << difficuly[cursor_iterator] << "   Your score: " << score << endl << endl << endl;

    cout << "                                                     Press C to retry" << endl;
